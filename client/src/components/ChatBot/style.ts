...
export const style = {
    chatBot: {position: 'absolute', right: 0, bottom: 0, overflow: 'hidden', width: {xs: '100%', md: 400}},
    chatBotContainer: {p: 1, border: `2px solid ${borderColor}`,borderTop: 'none', width: '95%'},
